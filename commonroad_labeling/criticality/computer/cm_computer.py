...
class CMComputer:
    ...
    def __init__(
        ...
        :param verbose: A boolean flag indicating whether the process should output detailed information. Defaults to True.
    ...
    def compute_metrics(
        ...
        :param ego_id: Identifier for the ego vehicle. If None, a trajectory for the ego vehicle will be simulated using Reactive Planner.
        :param save_plots: Boolean flag indicating whether to save plots generated during trajectory computation of Reactive Planner.
        :param show_plots: Boolean flag indicating whether to show plots generated during trajectory computation of Reactive Planner.
    ...
    def compute_metrics_for_id(
        ...
        :param output_dir: The directory path where output files will be saved, defaults to an "output" directory in the current working directory.
        """
    ...
    def compute_metrics_catching(
        ...
        """
        Computes the CMs for a given scenario file, catching and reporting any potential exceptions. Simulates the trajectory of the ego vehicle if needed.
        :param scenario_path: Path to the scenario file to be read.
        :param ego_id: Identifier for the ego vehicle. If None, a trajectory for the ego vehicle will be simulated using Reactive Planner.
        :param save_plots: Boolean flag indicating whether to save plots generated during trajectory computation of Reactive Planner.
        :param show_plots: Boolean flag indicating whether to show plots generated during trajectory computation of Reactive Planner.
