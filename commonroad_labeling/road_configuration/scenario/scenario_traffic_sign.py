...
class TrafficSign(ScenarioTag, ABC):
...
class TrafficSignSpeedLimit(TrafficSign):
    def __init__(self, scenario: Scenario):
        ...
        self.tag = TagEnum.SCENARIO_TRAFFIC_SIGN_SPEED_LIMIT
...
class TrafficSignRightOfWay(TrafficSign):
    def __init__(self, scenario: Scenario):
        super().__init__(scenario)
        self.tag = TagEnum.SCENARIO_TRAFFIC_SIGN_RIGHT_OF_WAY
...
class TrafficSignNoRightOfWay(TrafficSign):
    def __init__(self, scenario: Scenario):
        super().__init__(scenario)
        self.tag = TagEnum.SCENARIO_TRAFFIC_SIGN_NO_RIGHT_OF_WAY
...
class TrafficSignStopLine(ScenarioTag):
    def __init__(self, scenario: Scenario):
        super().__init__(scenario)
        self.tag = TagEnum.SCENARIO_TRAFFIC_SIGN_STOP_LINE
...
class TrafficSignTrafficLight(ScenarioTag):
    def __init__(self, scenario: Scenario):
        super().__init__(scenario)
        self.tag = TagEnum.SCENARIO_TRAFFIC_SIGN_TRAFFIC_LIGHT
